var createScene = async function (canvas, basePathMesh) {
    ...
    console.log("Loading mesh from " + basePathMesh + "...");
    ...
    // const result = await BABYLON.SceneLoader.ImportMeshAsync(null, basePathMesh, "Nemu/output.glb", scene);
    const result = await BABYLON.SceneLoader.ImportMeshAsync(null, basePathMesh, "jari_COCOS_GLTFTRANSFORM.glb", scene);
    ...
    */
    ...
    sphere.attachToBone(scene.skeletons[0].bones[4], mesh);
    ...
    console.log("Aiming camera at sphere...");
